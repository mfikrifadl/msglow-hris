...
header("Content-Disposition: attachment; filename=THR Operator(".$cPembayaran.") - PT. Global Insight Utama - ".$cBulan."-".date("Y")." .xls" );
header("Expires: 0");
...
$worksheet1->write_string(0,0,'THR  Operator Bulan  Tahun '.$tahun.' - PEMBAYARAN '.$cPembayaran.' ',$judul);  // Set Nama kolom
...
$jos = $this->db->query("CALL thr('".$bulan."','".$tahun."','".$bayar."')");
$no         = 0 ;
$nGajiPokok =   0   ;
