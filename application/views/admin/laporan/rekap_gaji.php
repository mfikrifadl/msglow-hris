...
header("Content-Disposition: attachment; filename=RekapGaji Bulan - ".$cBulan." Tahun - ".$tahun."- Pembayaran - ".$cPembayaran." .xls" );
header("Expires: 0");
...
$worksheet1->write_string(0,0,'Rekap Gaji Operator Bulan '.$cBulan.' Tahun '.$tahun.' - PEMBAYARAN '.$cPembayaran.' ',$judul);  // Set Nama kolom
...
$jos = $this->db->query("CALL rekapan_gaji_perpembayaran('".$bulan."','".$tahun."','".$bayar."')");   
}
