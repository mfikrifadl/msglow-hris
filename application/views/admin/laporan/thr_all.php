...
header("Content-Disposition: attachment; filename=THR Operator(Semua) - PT. Global Insight Utama - ".$cBulan."-".date("Y")." .xls" );
header("Expires: 0");
...
$worksheet1->write_string(0,0,'THR  Operator Bulan '.$cBulan.' Tahun '.$tahun.'  ',$judul);  // Set Nama kolom
...
$jos =$this->db->query("CALL thr_all('".$bulan."','".$tahun."')");
$no         = 0 ;
$nGajiPokok =   0   ;
