...
<hr/> 
<h3><strong>Data Rekap Gaji Bulan <?=$bulan?> Tahun <?=$tahun?></strong></h3>
...
<a href="<?=base_url()?>laporan/rekap_gaji_bulan/<?=$bulan?>/<?=$tahun?>" target="_blank" class="btn btn-primary btn-block">
  <i class="fa fa-print"></i> Cetak Semua Rekap Gaji
</a>
