          ...
          <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
              <ul class="nav navbar-nav navbar-right ">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-building-o"></i> Penjualan <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?=site_url('penjualan/laporan_penjualan_all')?>"><i class="fa fa-laptop"></i> Laporan Penjualan</a></li> 

                    <li><a href="<?=site_url('penjualan/laporan_penjualan_area')?>"><i class="fa fa-laptop"></i> Laporan Penjualan Per Area</a></li> 

                    <li><a href="<?=site_url('penjualan/laporan_penjualan_supervisor')?>"><i class="fa fa-laptop"></i> Laporan Penjualan Per Supervisor</a></li> 
