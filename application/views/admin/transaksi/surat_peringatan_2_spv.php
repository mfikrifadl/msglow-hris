  ...
  <?php 
        if($action == "edit") {
          ...
          $cAction = "Update/".$cIdSuratPeringatan."" ;
            ...
            $cCC                =   "" ;
            $cHeader            =   "Berdasarkan Evaluasi dan pengamatan terhadap sikap kerja serta setelah dikeluarkan Surat SP 1 dan teguran secara lisan sebanyak 2 kali  saudara ," ;
            $cIconButton    =   "save"    ;
...
<section class="connectedSortable">
    ...
    <div class="container">
      ...
      <div class="box box-primary collapsed-box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Table Surat Peringatan Pegawai (SP2) SPV</h3>
      ...
      <div style="display: none;" class="box-body">
        ...
        <ul class="nav nav-tabs" id="myTabs">
           <li class="active"><a href="#tab_1" data-toggle="tab">Data SP 2 SPV</a></li> 
        </ul>
            ...
            <table class="table table-striped table-bordered" id="DataTable">
              ...
              ?>
                <tr>
                  ...
                  <td align="center">
                    <a class="btn-link" title="View Data" target="_blank" href="<?=site_url('laporan/lp_sp_spv/'.$vaPeringatan['id'].'/2')?>">
                      <i class="fa fa-print"></i>
                    </a>|
                    <a class="btn-link" title="Edit Data" href="<?=site_url('surat/surat_peringatan_2_spv/edit/'.$vaPeringatan['id'].'')?>">
                      <i class="fa fa-edit"></i>
                    </a>|
                    <a class="btn-link"  title="Hapus Data" 
                      onclick="if(confirm('Apakah anda yakin akah menghapus data?'))
                      { window.location.href='<?=site_url('surat_act/surat_peringatan_2_spv/Delete/'.$vaPeringatan['id'].'')?>'}">
    ...
    action="<?=site_url('surat_act/surat_peringatan_2_spv/'.$cAction.'')?>">
    <div class="container">
      <div class="col-md-12 col-sm-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title">Form Surat Peringatan 2 SPV</h3>
            <div class="box-tools pull-right">
              <span class="label label-danger">Input (SP2) SPV</span>
