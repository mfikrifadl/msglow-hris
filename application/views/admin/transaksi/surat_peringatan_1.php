...
<section class="connectedSortable">
    ...
    <div class="container">
      ...
      <div class="box box-primary collapsed-box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Table Surat Peringatan Pegawai (SP1)</h3>
      ...
      <div style="display: none;" class="box-body">
        ...
        <ul class="nav nav-tabs" id="myTabs">
           <li class="active"><a href="#tab_1" data-toggle="tab">Data SP1 Pegawai </a></li> 
        </ul>
            ...
            <table class="table table-striped table-bordered" id="DataTable">
              ...
              ?>
                <tr>
                  ...
                  <td align="center">
                    <a class="btn-link" title="View Data" target="_blank" href="<?=site_url('laporan/lp_sp/'.$vaPeringatan['id'].'/1')?>">
                      <i class="fa fa-print"></i>
                    </a>|
                    <a class="btn-link" title="Edit Data" href="<?=site_url('surat/surat_peringatan_1/edit/'.$vaPeringatan['id'].'')?>">
                      <i class="fa fa-edit"></i>
                    </a>|
                    <a class="btn-link"  title="Hapus Data" 
                      onclick="if(confirm('Apakah anda yakin akah menghapus data?'))
                      { window.location.href='<?=site_url('surat_act/surat_peringatan_1/Delete/'.$vaPeringatan['id'].'')?>'}">
    ...
    action="<?=site_url('surat_act/surat_peringatan_1/'.$cAction.'')?>">
    <div class="container">
      <div class="col-md-12 col-sm-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title">Form Surat Peringatan 1</h3>
            <div class="box-tools pull-right">
              <span class="label label-danger">Input (SP1)</span>
            ...
            <div class="row">
              ...
              <div class="container">
                ...
                <div class="col-sm-9" align="left">
                  ...
                  <p><h4>Berdasarkan Surat Peryataan dan hasil pengamatan terhadap sikap kerja setelah teguran Lisan dilakukan, diperoleh informasi bahwa saudara,</h4> </p>
                </div>
              </div>
              <br/>
              <div class="container">
