    ...
    <link href="<?=base_url()?>assets/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
      <table class="table table-striped table-bordered DataTablePegawaiJos" >
          <thead>
            <tr>
              <td>No</td>
              <td>Id</td>
        ...
        <div class="modal fade bs-example-modal-lg" id="lapangan" tabindex="-1" role="dialog" aria-hidden="true">
