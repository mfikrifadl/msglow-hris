      ...
      <table class="table table-striped table-bordered DataTablePegawaiMasaKerja" >
          ...
          <tbody>
            ...
            <?php //include 'detail.pegawai.php'; ?>
              <td ><?=++$no?></td>
              <td style="width:20%"><?=$vaPegawai['nama']?></td>
              <td style="width:10%"><?=$vaPegawai['nik']?></td>
              <td style="width:10%"><font color="green"><?=String2Date($vaPegawai['tanggal_masuk_kerja'])?></font></td>
              <td style="width:10%"><font color="red"><?=String2Date($vaPegawai['tanggal_keluar'])?></font></td>
              <td style="width:5%"><?=$vaPegawai['MasaKerja']?></td>
              <td style="width:30%"><?=$vaPegawai['keterangan']?></td>
              <td style="width:20%">
              <a class="btn btn-danger btn-flat" target="_blank" title="View Data" href="<?=site_url('transaksi/view_pegawai/'.$vaPegawai['id_pegawai'].'')?>">
                <i class="fa fa-eye"></i>
              </a>
       ...
       <div class="modal fade bs-example-modal-lg" id="operator-resign" tabindex="-1" role="dialog" aria-hidden="true">
