              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <select id="tglP" onchange="getDataTanggal();" class="form-control kt-selectpicker" data-live-search="true" name="cIdPegawai">
                      <option></option>
  ...
  <script>
    function getDataTanggal() {
      ...
      var result = document.getElementById("tglP").value;

      // var cNama = $('#tglP').val();
      $.ajax({
        type: "POST",
        url: "<?= base_url() ?>transaksi_act/getTanggalMasukKerja/" + result,
        cache: false,
        beforeSend: function() {
          $('#show').html("Cek Data Ke Sistem .. ");
        },
