 <?php 
   ...
   foreach ($NoLast->result_array() as $key => $vaDataLast) {
    ...
    $cNomorSuratFix = "No."."####"."/GN/P-SP 1/".$cRomawai."/".date("Y")." ";
    ?>
  <?php 
        if($action == "edit") {
          ...
          $cAction = "Update/".$cIdSuratPeringatan."" ;
            ...
            $cCC                =   "" ;
            $cHeader            =   "Berdasarkan Surat Pernyataan dan hasil pengamatan terhadap sikap kerja setelah teguran lisan dilakukan,
diperoleh informasi bahwa saudara" ;
            $cIconButton    =   "save"    ;
...
<section class="connectedSortable">
    ...
    <div class="container">
      ...
      <div class="box box-primary collapsed-box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Table Surat Peringatan Pegawai (SP1) SPV</h3>
      ...
      <div style="display: none;" class="box-body">
        ...
        <ul class="nav nav-tabs" id="myTabs">
           <li class="active"><a href="#tab_1" data-toggle="tab">Data SP1 SPV </a></li> 
        </ul>
            ...
            <table class="table table-striped table-bordered" id="DataTable">
              ...
              ?>
                <tr>
                  ...
                  <td align="center">
                    <a class="btn-link" title="View Data" target="_blank" href="<?=site_url('laporan/lp_sp_spv/'.$vaPeringatan['id'].'/1')?>">
                      <i class="fa fa-print"></i>
                    </a>|
                    <a class="btn-link" title="Edit Data" href="<?=site_url('surat/surat_peringatan_1_spv/edit/'.$vaPeringatan['id'].'')?>">
                      <i class="fa fa-edit"></i>
                    </a>|
                    <a class="btn-link"  title="Hapus Data" 
                      onclick="if(confirm('Apakah anda yakin akah menghapus data?'))
                      { window.location.href='<?=site_url('surat_act/surat_peringatan_1_spv/Delete/'.$vaPeringatan['id'].'')?>'}">
    ...
    action="<?=site_url('surat_act/surat_peringatan_1_spv/'.$cAction.'')?>">
    <div class="container">
      <div class="col-md-12 col-sm-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title">Form Surat Peringatan 1 SPV</h3>
            <div class="box-tools pull-right">
              <span class="label label-danger">Input (SP1) SPV</span>
          ...
          <div class="box-body">
            <div class="row">
              <div align="center">
               <h3>Surat Peringatan Pertama</h3><br/>
                <?php if($action != 'edit'){ ?>
              ...
              <div class="container">
                ...
                <div class="col-sm-9" align="left">
                  ...
                  <textarea name="cHeader" class="form-control"><?=$cHeader?></textarea>
                </div>
              </div>
              <br/>
              <div class="container">
                ...
                <div class="col-sm-9" align="center">
                  <div class="row">
                    <div class="col-sm-2">NAMA SPV</div>
                    <div class="col-sm-1">:</div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      <p color="red">*Jika Nama Operator/SPV Belum Ada Di List Harap Memasukkan Data Terlebih Dahulu ,<a href="<?=site_url('transaksi/pegawai')?>">Klik Disini</a> Untuk Menambah Data Operator/SPV</p>
                    </div>
                  </div>
                  <br/>
                  <div class="row">
                  ...
                  <br/>
                  <div class="row">
                    <div class="col-sm-2">SPV Wilayah</div>
                    <div class="col-sm-1">:</div>
                    <div class="col-sm-4">
              ...
              <div class="container">
                <div class="col-sm-1">&nbsp;</div>
                <div class="col-sm-9" align="left">
                  <p><h4>Telah melakukan tindakan/perbuatan yang melanggar Tata Tertib Kerja/SOP/Job Desk dan Kepegawaian yang dilakukan pada :</h4> </p>
                </div>
              </div>
              <br/>
              <div class="container">
              ...
              <div class="container">
                <div class="col-sm-1">&nbsp;</div>
                <div class="col-sm-9" align="left">
                  <p><h4>Demikian Surat Peringatan Pertama ini dikeluarkan untuk menjadi perhatian.</h4> </p>
                </div>
              </div>
              <br/><br/>
              <div class="container">
