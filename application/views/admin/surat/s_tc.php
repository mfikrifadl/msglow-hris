 <?php 
  ...
  if(date("m") == '01'){
   ...
   if($IdKategoriSurat == 24){
      ...
      $cKet     = "TIM OMSET";
      $cJabatan = 52;
    }elseif($IdKategoriSurat == 35){
      $SuratKet = 'Surat Pengantar Training Center';
      $cKet     = "OPERATOR BARU";
      $cJabatan = 45;
    }
...
<section class="connectedSortable">
    ...
    <div class="container">
      ...
      <div class="box box-primary collapsed-box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Table Surat Pengantar Training Center</h3>
      ...
      <div style="display: none;" class="box-body">
        ...
        <ul class="nav nav-tabs" id="myTabs">
          <li class="active"><a href="#tab_1" data-toggle="tab">Data Surat Pengantar Training Center </a></li> 
        </ul>
            ...
            <table class="table table-striped table-bordered" id="DataTable">
              ...
              <?php $no = 0 ; foreach ($row as $key => $vaTugas) { ?>
                <tr>
                  ...
                  <td align="center">
                    <a class="btn-link" title="View Data" href="<?=site_url('laporan/lp_tc/'.$vaTugas['id_tugas'].'')?>" target="_blank">
                      <i class="fa fa-print"></i>
                    </a>|
                    <a class="btn-link" title="Edit Data" href="<?=site_url('surat/pengantar_tc/'.$vaTugas['id_kategori_surat'].'/edit/'.$vaTugas['id_tugas'].'')?>">
                      <i class="fa fa-edit"></i>
                    </a>|
                     <a class="btn-link" title="Hapus Data" onclick="if(confirm('Apakah anda yakin akah menghapus data?'))
                      { window.location.href='<?=site_url('surat_act/tugas_tc/Delete/'.$vaTugas['id_tugas'].'/'.$vaTugas['id_kategori_surat'].' ')?>'}">
    ...
    action="<?=site_url('surat_act/tugas_tc/'.$cAction.'')?>">
    <div class="container">
      <div class="col-md-12 col-sm-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title">Data Surat Pengantar Training Center</h3>
            <div class="box-tools pull-right">
              <span class="label label-danger">Input Data Surat Pengantar Training Center</span>
          ...
          <div class="box-body">
            <div class="row">
              <div align="center">  
                <h3>Surat Pengantar Training Center</h3>
                <?php if($action != 'edit'){ ?>
