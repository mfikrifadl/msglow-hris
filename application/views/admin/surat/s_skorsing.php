 <?php 
    ...
    $cNomorSuratFix = "No."."####"."/GN/HRD-SK/".$cRomawai."/".date("Y")." ";
    ...
    if($NoLast->num_rows() > 0){
      ...
      $NoSuratTerakhir = "No.0001/GN/HRD-SK/".$cRomawai."/".date("Y")."";
    }
  ...
  <?php 
        if($action == "edit") {
          foreach ($field as $column) {
            $cIdSkorsing      =   $column['id_skorsing'];
...
<section class="connectedSortable">
    ...
    <div class="container">
      ...
      <div class="box box-primary collapsed-box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Table Skorsing  Pegawai</h3>
      ...
      <div style="display: none;" class="box-body">
        ...
        <ul class="nav nav-tabs" id="myTabs">
          <li class="active"><a href="#tab_1" data-toggle="tab">Data Skorsing Pegawai </a></li> 
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            <table class="table table-striped table-bordered" id="DataTable">
              ...
              <tbody>
              <?php $no = 0 ; foreach ($row as $key => $vaSkorsing) { ?>
                <tr>
                  <td><?=++$no;?></td>
                  <td><?=String2Date($vaSkorsing['tgl'])?></td>
                  <td><?=($vaSkorsing['nomor_surat'])?></td>
                  <td><?=$vaSkorsing['NikPegawai']?></td>
                  <td><?=($vaSkorsing['NamaPegawai'])?></td>
                  <td align="center">
                    <a class="btn-link" title="View Data" target="_blank" href="<?=site_url('laporan/lp_skorsing/'.$vaSkorsing['id_skorsing'].'')?>">
                      <i class="fa fa-print"></i>
                    </a>|
                    <a class="btn-link" title="Edit Data" href="<?=site_url('surat/skorsing_pegawai/edit/'.$vaSkorsing['id_skorsing'].'')?>">
    ...
    action="<?=site_url('surat_act/skorsing_pegawai/'.$cAction.'')?>">
    <div class="container">
      <div class="col-md-12 col-sm-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h3 class="box-title">Data Skorsing</h3>
            <div class="box-tools pull-right">
              <span class="label label-danger">Input Data Skorsing</span>
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-sm-5">
               <div class="form-group">
                <label>Outlet</label>
                <input type="text" name="cOutlet" value="<?=$cOutlet?>" 
                class="form-control" placeholder="Outlet Terakhir">
               </div>
              </div>
              <div class="col-sm-4">
              <p color="red">*Isi Dengan Tempat Outlet Terakhir Dari Pegawai Yang Diskorsing</p>
            </div>
            </div>
            <div class="row">
              <div class="col-sm-5">
               <div class="form-group">
                ...
                <input type="text" name="nLama" value="<?=$nLama?>" 
                class="form-control" placeholder="Lama Skorsing">
               </div>
              </div>
              <div class="col-sm-4">
              <p color="red">*Isi Dengan Lama Skorsing Pegawai </p>
            </div>
            </div>
            <div class="row">
              <div class="col-sm-5">
              ...
              <div class="col-sm-2">
              <p color="red">*Range Tanggal Skorsing</p>
            </div>
            </div>
            <div class="row">
               <div class="col-sm-6">
               <label>CC</label>
                <textarea class="form-control" name="cCC"><?=$cCC?></textarea>
              </div>
            </div>
            <br/>
            <div class="row">
