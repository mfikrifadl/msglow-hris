                                                        ...
                                                        <div class="kt-portlet__body">
                                                            <div class="row">
                                                                ...
                                                                if ($row['reg_skck'] != null) { ?>
                                                                    <!-- <iframe height="400px" width="100%" src="<?php //echo base_url() . $row['reg_skck']; ?>" style="width:100%; border:none;"></iframe> -->
                                                        ...
                                                        <div class="kt-portlet__body">
                                                            <div class="row">
                                                                ...
                                                                <iframe height="400px" width="100%" src="<?= "http://103.157.96.97/career/" . $row['reg_cv'] . "/" . $row['reg_judul']; ?>" style="width:100%; border:none;"></iframe>
                                                                    <!-- <iframe height="400px" width="100%" src="<?php //echo base_url() . $row['reg_cv'] . "/" . $row['reg_judul']; ?>" style="width:100%; border:none;"></iframe> -->
                                                                <?php } else {
                                                                }
                                                                ?>
                                                            </div><!-- /.row -->
